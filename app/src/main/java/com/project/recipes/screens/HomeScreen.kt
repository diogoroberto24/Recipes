...
@Composable
fun MyBottonAppBar(modifier: Modifier = Modifier) {
    val items = listOf(
...
@Preview
@Composable
private fun MyBottonAppBarPreview() {
    RecipesTheme() {
        MyBottonAppBar()
    }
}
...
fun ContentScreen(
    ...
    Column(
        ...
        Card(
            ...
            Image(
                painter = painterResource(R.drawable.coocking_baner),
                contentDescription = stringResource(R.string.coocking_card),
                modifier = Modifier
                    .fillMaxWidth(),
